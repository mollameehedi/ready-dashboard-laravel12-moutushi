                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body">
                               <form action="{{route('admin.settings.website.page.update',$page->slug)}}" method="POST">
                                @csrf
                                <div class="form-group my-2">
                                    <textarea class="form-control" name="description" id="description" cols="30" rows="10">{{$page->description}}</textarea>
                                </div>
                                <button type="submit" class="btn btn-primary">Update</button>
                                <a href="{{ route('admin.settings.website.page.index') }}" class="btn btn-danger">Cancel</a>
                               </form>
                            </div>
                        </div>
                    </div>
